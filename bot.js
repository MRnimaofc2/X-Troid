        ...
        if (config.WORKTYPE == 'public') {
            ...
            if (config.LANG == 'SI' || config.LANG == 'EN') {
                if (config.AILIZA == 'true') {
                    ...
                    await conn.sendMessage(conn.user.jid, '*Welcome to X-Troid MR Nima Edition*  \n\n 🔥._මෙය ඔබගේ ලොග් සටහන් අංකය බැවින් මෙහි එන පණිවුඩ සහා අවධානයෙන් සිටින්න._\n 🔥._ඔබට ඕනෑම චැට් එකක විධාන උත්සාහ කළ හැකිය නමුත් මෙහි නොකරන්න:)_\n\n🔥. *bot පොදු ලෙස ක්‍රියාකරයි .වෙනස් කිරීමට* _.setvar WORK_TYPE: private_ *ඔබේ විධානය භාවිතා කරන්න.*\n\n*🐺 X-Troid Nima භාවිතා කිරීම ගැන ස්තූතියි තවත් තොරතුරු දැනගැනීමට  අප හා රැදීසින්න* \n\n˜”*°•.˜”*°•  🎡 *x-ᴛʀᴏɪᴅ ɴɪᴍᴀ*  🎡  •°*”˜.•°*”˜ ', MessageType.text);
                }
                await git.fetch();
