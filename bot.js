        ...
        if (config.WORKTYPE == 'public') {
            ...
            if (config.LANG == 'SI' || config.LANG == 'EN') {
                if (config.AILIZA == 'true') {
                    ...
                    await conn.sendMessage(conn.user.jid, '😈    *WELCOME TO x-ᴛʀᴏɪᴅ ɴɪᴍᴀ EDITION*   😈\n\n\n*🐺:* *නිවේදනය !*\n\n*🪀 මෙය ඔබගේ ලොග් අංකයවේ 🪀*\n❐  _මෙයට පැමිනෙන පණිවිඩ පිලිබද අවධානයෙන් සිටින්න_\n❐  _මෙම ලොග් අංකය තුල කමාන්ඩ් බාවිත කිරීමෙන් වලකින්න  ⛔ වෙනත් ස්තානයක කමාන්ඩ් බාවිතකරන්න !_\n\n\n👾 *ඔබගේ බොට් පොදු ආකාරයට ක්‍රියාකරයි*\n🎡 *එය වෙනස් කිරීමට අවශය* නම් \n   .setvar WORK_TYPE:private  *බාවිතාකරන්න 😊*\n\n\n*▷*══ *ᴛʜᴀɴᴋs ғʀᴏ ᴜsɪɴɢ x-ᴛʀᴏɪᴅ ɴɪᴍᴀ ᴇᴅɪᴛɪᴏɴ* ', MessageType.text);
                }
                await git.fetch();
